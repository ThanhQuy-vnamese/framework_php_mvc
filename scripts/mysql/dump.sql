...
CREATE TABLE IF NOT EXISTS `medican_user_profiles` (
                                                       `id` int PRIMARY KEY AUTO_INCREMENT,
                                                       `user_id` int,
...
CREATE TABLE IF NOT EXISTS `medican_medican_records` (
                                                         `id` int PRIMARY KEY AUTO_INCREMENT,
                                                         `user_id` int,
...
CREATE TABLE IF NOT EXISTS `medican_heaths` (
                                                `id` int PRIMARY KEY AUTO_INCREMENT,
                                                `summary` varchar(255),
    `healths` text,
    `note` text,
...
CREATE TABLE IF NOT EXISTS `medican_blogs` (
                                               `id` int PRIMARY KEY AUTO_INCREMENT,
                                               `title` varchar(255),
    `content` text,
    `created_at` timestamp,
...
CREATE TABLE IF NOT EXISTS `medican_contact_infomation` (
                                                            `id` int PRIMARY KEY AUTO_INCREMENT,
                                                            `user_id` int,
                                                            `email` varchar(255),
    `phone` varchar(12),
...
CREATE TABLE IF NOT EXISTS `medican_appointments` (
                                                      `id` int PRIMARY KEY AUTO_INCREMENT,
                                                      `subject` varchar(100),
...
CREATE TABLE IF NOT EXISTS `medican_appointment_attendees` (
                                                               `id` int PRIMARY KEY AUTO_INCREMENT,
                                                               `id_appointment` int,
                                                               `user_id` int,
                                                               `created_at` timestamp,
...
CREATE TABLE IF NOT EXISTS `medican_medicines` (
                                                   `id` int PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `medican_medicines_types` (
                                                         `id` int PRIMARY KEY AUTO_INCREMENT,
                                                         `name` varchar(255),
    `description` text
    );

CREATE TABLE IF NOT EXISTS `medican_prescriptions` (
                                                       `id` int PRIMARY KEY AUTO_INCREMENT,
                                                       `user_id` int,
                                                       `name` varchar(255),
    `address` varchar(255),
...
CREATE TABLE IF NOT EXISTS `medican_prescription_details` (
                                                              `id` int PRIMARY KEY AUTO_INCREMENT,
                                                              `prescription_id` int,
                                                              `medicine_id` int,
...
ALTER TABLE `medican_appointments` ADD FOREIGN KEY (`id`) REFERENCES `medican_appointment_attendees` (`id_appointment`);
...
ALTER TABLE `medican_medicines_types` ADD FOREIGN KEY (`id`) REFERENCES `medican_medicines` (`medicine_type_id`);
